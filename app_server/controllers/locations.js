const locations = [
  {
    ...
    rating: 3,
    facilities: ['clothes', 'Food', 'Premium wifi'],
    distance: '100m',
    description: 'mjr square is on Loc8r because it has accessible wifi and space to sit down with your laptop and get some work done.',
  ...
  },
  {
    ...
    distance: '200m',
    description: '90s cafe is a great place for coffee and snacks with fast wifi.',
  ...
  },
  {
    ...
    distance: '250m',
    description: 'Burger king offers tasty food and premium wifi for all customers.',
